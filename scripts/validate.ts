import { GameData } from "../src/models/SongData";
...
function validateContents(dataFilename: string, dataFile: GameData) {
  const errors = [];
...
compile(songsSchema, "SongData", { bannerComment }).then((ts: any) => {
